        ...
        <motion.div
            ...
            >
                ...
                <div>
                    ...
                    <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[32px] leading-[16px] text-white" >
                        Founder | Metaversus
                    </p>
                </div>
            ...
            >
                ...
                <Link to='explore' duration={1.2} smooth={true} spy={true}>
                    ...
                    >
                        <img src="/stamp.png" alt="stamp" className="w-[155px] h-[155px] object-contain cursor-pointer" />
                    </motion.div>
                </Link>
